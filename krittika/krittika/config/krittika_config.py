...
class KrittikaConfig:
    def __init__(self):
        ...
        # USER, IFMAP, FILTER, AUTO, SET_RA_TREE (Best effort first filter, then inputs)
    ...
    def read_config_from_file(self, filename):
        ...
        assert part_strategy in ['USER', 'IFMAP', 'FILTER', 'CONST_DF', 'AUTO', 'SET_RA_TREE'], \
            'Invalid partition mode ' + part_strategy + '. Supported vals: [USER, AUTO, IFMAP, FILTER, CONST_DF, SET_RA_TREE]'
    ...
    def set_config_vals(self,
        ...
        assert partition_mode in ['USER', 'AUTO', 'IFMAP', 'FILTER', 'CONST_DF', 'SET_RA_TREE'], 'Invalid partition mode provided'
    ...
    def set_partition_mode(self, part_mode = ''):
        assert self.config_valid
        assert part_mode in ['USER', 'AUTO', 'IFMAP', 'FILTER', 'CONST_DF', 'SET_RA_TREE'], 'Invalid partition mode provided'
